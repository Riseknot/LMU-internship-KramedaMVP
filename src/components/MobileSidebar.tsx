...
import { Calendar, Trophy, Map, LogOut, X, Euro, Users, User as UserIcon, CheckCircle, List, Phone, Shield, Calculator, Heart, UserCheck } from 'lucide-react';
    ...
    <>
      ...
      <div className="fixed top-0 left-0 h-full w-80 bg-white shadow-2xl z-50 lg:hidden flex flex-col animate-in slide-in-from-left duration-300">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <div className="p-2 bg-gradient-to-br from-accent-400 to-accent-500 rounded-lg shadow-lg">
            ...
            <div className="flex items-center gap-3 p-3 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 shadow-lg">
              <div className="w-12 h-12 bg-gradient-to-br from-accent-400 to-accent-500 rounded-full flex items-center justify-center shadow-lg ring-2 ring-white/20">
        ...
        <nav className="flex-1 overflow-y-auto p-4 bg-gradient-to-b from-neutral-50/50 to-white">
          ...
          <div className="mb-4">
            <a
              ...
              className="w-full flex items-center gap-3 px-4 py-4 bg-gradient-to-r from-error to-red-600 text-white rounded-xl font-medium shadow-lg shadow-error/30 hover:shadow-xl hover:shadow-error/40 transition-all duration-200 active:scale-[0.98] group"
            >
              ...
              return (
                <li key={item.id}>
                  ...
                  >
                    ...
                    {isActive && (
                      <div className="ml-auto w-1.5 h-1.5 rounded-full bg-accent-300 animate-pulse"></div>
                    )}
                  </button>
                </li>
              );
        ...
        <div className="p-4 border-t border-neutral-200 bg-gradient-to-br from-neutral-50 to-white">
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-4 py-3.5 text-error hover:bg-error/10 rounded-xl font-medium transition-all duration-200 group hover:shadow-md active:scale-[0.98]"
          >
