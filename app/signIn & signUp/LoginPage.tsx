      ...
      <div className="auth-shell-inner w-full max-w-md">
        ...
        <div className="text-center mb-6">
            ...
            <div className="relative inline-block">
              ...
              <h1 className="relative bg-gradient-to-r from-amber-100 via-sky-200 to-violet-200 bg-clip-text pl-[0.15em] text-7xl font-black tracking-[0.36em] text-transparent drop-shadow-[0_0_24px_rgba(126,220,255,0.18)] sm:text-9xl">
                LUMI
              </h1>
            </div>
            <Slogan />
